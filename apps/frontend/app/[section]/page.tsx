...
const sections: Record<string, SectionConfig> = {
  ...
  purchasing: { title: "Purchasing", copy: "See supplier purchases across both divisions and the cost entering Tjekatjeka inventory.", endpoint: "purchases", note: "Material-linked purchases automatically increase raw-material stock and preserve supplier/reference information for audit.", columns: [["purchase_date","Date","text"],["supplier_name","Supplier","text"],["reference","Reference","text"],["quantity","Quantity","number"],["unit_cost","Unit cost","money"],["total_cost","Total","money"]] },
  ...
  finance: { title: "Finance & Expenses", copy: "Keep operating costs visible by branch, category and date instead of mixing every cost into one company total.", endpoint: "expenses", note: "The executive dashboard combines expenses with purchasing, fuel and maintenance to show tracked operating spend.", columns: [["expense_date","Date","text"],["category","Category","text"],["description","Description","text"],["supplier_name","Supplier / Payee","text"],["amount","Amount","money"]] },
  fleet: { title: "Fleet", copy: "Manage trucks and smaller vehicles with odometer, availability and operating-status visibility.", endpoint: "vehicles", note: "Fuel logs reject backwards odometer readings. Maintenance and fuel costs feed the management dashboard separately from branch purchasing.", columns: [["registration","Registration","text"],["make","Make","text"],["model","Model","text"],["vehicle_type","Type","text"],["odometer_km","Odometer km","number"],["status","Status","text"]] },
};
