...
export default async function DeliveriesPage(){
 ...
 return <Shell active="/deliveries">
  <section className="page-head"><div><span className="eyebrow">Logistics</span><h1>Deliveries & Dispatch</h1><p>Plan customer deliveries, assign trucks and drivers, and follow each load through to delivery.</p></div></section>
  ...
  <DeliveryControl vehicles={vehicles} branches={branches} deliveries={deliveries}/>
